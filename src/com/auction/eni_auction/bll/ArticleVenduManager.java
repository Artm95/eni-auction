...
public class ArticleVenduManager {
    ...
    public ArticleVendu addArticle(String category, String nom, String description, String start, String end, String price,
    	...
    	if (category == null || category.equals("")) {
    		...
    		if (categorie == null) {
    			be.addError("La catégorie sélectionné est invalide.");
    		}
    	}
    	...
    	if (start == null || start.equals("") || end == null || end.equals("")) {
    		...
    		try {
    			...
    			if (dateStart.compareTo(LocalDate.now()) < 0) {
    				be.addError("La date début ne doit pas être antérieur à celle du jour.");
    			}
    			
    			if (dateStart.compareTo(dateEnd) > 0) {
    				be.addError("La date de fin ne doit pas être antérieur à celle de début.");
    			}
    		} catch (Exception e) {
    	...
    	if (price == null || price.equals("")) {
    		...
    		be.addError("Le prix doit être un entier supérieur à 0.");
    	}
