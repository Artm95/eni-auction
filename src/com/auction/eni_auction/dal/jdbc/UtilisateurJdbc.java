...
public class UtilisateurJdbc implements UtilisateurDAO {
	...
	private static final String SELECT_CREDENTIALS = "SELECT TOP 1 no_utilisateur, pseudo, nom, prenom, email, telephone, rue, code_postal, ville, mot_de_passe, credit, administrateur FROM UTILISATEURS WHERE email = ? AND mot_de_passe = ?";
